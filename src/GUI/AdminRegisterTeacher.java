 ...
 * @author sanka
 */
public class AdminRegisterTeacher extends javax.swing.JFrame {

    /**
     * Creates new form AdminRegisterTeacher
     */
    public AdminRegisterTeacher() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel7.setText("You can give a Password,");

        jLabel8.setText("Teacher Can Change it ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (Email.isEmpty()) {
            JOptionPane.showConfirmDialog(this, "Please Enter a Email");
        } else if (Fname.isEmpty()) {
            JOptionPane.showConfirmDialog(this, "Please Enter a First Name");
        } else if (Lname.isEmpty()) {
            JOptionPane.showConfirmDialog(this, "Please Enter a Last Name");
        } else if (Mobile.isEmpty()) {
            JOptionPane.showConfirmDialog(this, "Please Enter a Mobile Number");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminRegisterTeacher.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminRegisterTeacher().setVisible(true);
            }
        });
    }
